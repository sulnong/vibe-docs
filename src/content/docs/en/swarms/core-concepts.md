---
title: "Swarms: Core Concepts"
description: "Core Concepts for Swarms: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---

# Swarms: Core Concepts
...
- Search intent: Build the mental model for Swarms objects before choosing an architecture.
- Core question: How do Agent, Swarm, Workflow, Tool, Memory, Output, and Architecture fit together?
- Differentiated angle: Explain concepts through task dependency shapes instead of reproducing the API glossary.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Swarms, "Core Objects" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
### 2. How Objects Compose

Use this section to reduce a broad documentation topic into a decision the reader can act on. For Swarms, "How Objects Compose" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
### 3. Task Dependency Shape

Use this section to reduce a broad documentation topic into a decision the reader can act on. For Swarms, "Task Dependency Shape" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Swarms, "Common Misreadings" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about Core Concepts. How do Agent, Swarm, Workflow, Tool, Memory, Output, and Architecture fit together?
