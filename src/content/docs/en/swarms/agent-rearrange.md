---
title: "Swarms: AgentRearrange"
description: "AgentRearrange for Swarms: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---

# Swarms: AgentRearrange
...
- Search intent: Use AgentRearrange flow syntax for readable mixed sequential and parallel flows.
- Core question: How far can `->` and `,` carry a workflow before GraphWorkflow becomes clearer?
- Differentiated angle: Treat flow syntax as a lightweight dependency DSL with a readability boundary.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about AgentRearrange. How far can `->` and `,` carry a workflow before GraphWorkflow becomes clearer?
