---
title: "Swarms: MCP and AOP"
description: "MCP and AOP for Swarms: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---
...
- Search intent: Connect Swarms agents to external systems through MCP and the Agent Orchestration Protocol.
- Core question: When should a capability be exposed as an MCP tool, and when should agents be service-orchestrated through AOP?
- Differentiated angle: Separate tool interoperability from queue-backed agent service orchestration.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about MCP and AOP. When should a capability be exposed as an MCP tool, and when should agents be service-orchestrated through AOP?
