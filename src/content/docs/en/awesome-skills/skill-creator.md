...
description: "Skill Creator Skill: Guides the creation of skills that extend an agent with specialized workflows."
---

# Skill Creator Skill

Guides the creation of skills that extend an agent with specialized workflows.

This page helps you decide whether to install or invoke `anthropics/skill-creator`, and how to keep the first use bounded.
...
| Directory listing | https://officialskills.sh/anthropics/skills/skill-creator |
| Primary source | https://officialskills.sh/anthropics/skills/skill-creator |
...
Start from the listing page: https://officialskills.sh/anthropics/skills/skill-creator

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/anthropics/skills/skill-creator
...
- Whether `anthropics/skill-creator` is better than a one-off prompt for this task.
...
- If the task is closer to "Provides a basic template for creating new skills.", check [Template Skill](/en/awesome-skills/template/) first; use this page when the focus remains "Guides the creation of skills that extend an agent with specialized workflows.".
- If the task is closer to "Addresses review and issue comments on open GitHub pull requests via CLI.", check [GitHub Address Comments Skill](/en/awesome-skills/gh-address-comments/) first; use this page when the focus remains "Guides the creation of skills that extend an agent with specialized workflows.".
- If the task is closer to "Debugs and fixes failing GitHub Actions checks through log inspection.", check [GitHub Fix CI Skill](/en/awesome-skills/gh-fix-ci/) first; use this page when the focus remains "Guides the creation of skills that extend an agent with specialized workflows.".
- If the task is closer to "Creates clean, reproducible Jupyter notebooks for experiments and tutorials.", check [Jupyter Notebook Skill](/en/awesome-skills/jupyter-notebook/) first; use this page when the focus remains "Guides the creation of skills that extend an agent with specialized workflows.".
