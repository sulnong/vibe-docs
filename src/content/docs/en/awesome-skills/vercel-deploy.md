...
description: "Vercel Deploy Skill: Deploys applications and websites to Vercel preview or production environments."
---

# Vercel Deploy Skill

Deploys applications and websites to Vercel preview or production environments.

This page helps you decide whether to install or invoke `openai/vercel-deploy`, and how to keep the first use bounded.

## Quick facts

| Field | Value |
| --- | --- |
| Skill | `openai/vercel-deploy` |
| Category | [Deployment and Platform Ops](/en/awesome-skills/categories/deployment-platform/) |
| Directory listing | https://officialskills.sh/openai/skills/vercel-deploy |
| Primary source | https://officialskills.sh/openai/skills/vercel-deploy |
...
Start from the listing page: https://officialskills.sh/openai/skills/vercel-deploy

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/openai/skills/vercel-deploy
...
- Whether `openai/vercel-deploy` is better than a one-off prompt for this task.
...
- If the task is closer to "Covers Cloudflare Workers, Pages, storage, AI, networking, security, and infrastructure configuration.", check [Cloudflare Skill](/en/awesome-skills/cloudflare/) first; use this page when the focus remains "Deploys applications and websites to Vercel preview or production environments.".
- If the task is closer to "Reviews and authors Workers code against production best practices and `wrangler.jsonc` conventions.", check [Workers Best Practices Skill](/en/awesome-skills/workers-best-practices/) first; use this page when the focus remains "Deploys applications and websites to Vercel preview or production environments.".
- If the task is closer to "Deploys and manages Workers, KV, R2, D1, Vectorize, Queues, and Workflows with Wrangler.", check [Wrangler Skill](/en/awesome-skills/wrangler/) first; use this page when the focus remains "Deploys applications and websites to Vercel preview or production environments.".
- If the task is closer to "Deploys apps to Cloudflare using Workers, Pages, and related platform services.", check [Cloudflare Deploy Skill](/en/awesome-skills/cloudflare-deploy/) first; use this page when the focus remains "Deploys applications and websites to Vercel preview or production environments.".
