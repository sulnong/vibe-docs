---
title: "XLSX Skill"
description: "XLSX Skill: Creates, edits, and analyzes Excel spreadsheets."
---

# XLSX Skill

Creates, edits, and analyzes Excel spreadsheets.

This page helps you decide whether to install or invoke `anthropics/xlsx`, and how to keep the first use bounded.
...
| Directory listing | https://officialskills.sh/anthropics/skills/xlsx |
| Primary source | https://officialskills.sh/anthropics/skills/xlsx |
...
Start from the listing page: https://officialskills.sh/anthropics/skills/xlsx

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/anthropics/skills/xlsx
...
- Whether `anthropics/xlsx` is better than a one-off prompt for this task.
...
- If the task is closer to "Creates, edits, and analyzes Microsoft Word documents.", check [DOCX Skill](/en/awesome-skills/docx/) first; use this page when the focus remains "Creates, edits, and analyzes Excel spreadsheets.".
- If the task is closer to "Extracts text, creates PDFs, and handles PDF forms and review tasks.", check [PDF Skill](/en/awesome-skills/pdf/) first; use this page when the focus remains "Creates, edits, and analyzes Excel spreadsheets.".
- If the task is closer to "Creates, edits, and analyzes PowerPoint presentations.", check [PPTX Skill](/en/awesome-skills/pptx/) first; use this page when the focus remains "Creates, edits, and analyzes Excel spreadsheets.".
- If the task is closer to "Provides authoritative guidance from OpenAI developer documentation.", check [OpenAI Docs Skill](/en/awesome-skills/openai-docs/) first; use this page when the focus remains "Creates, edits, and analyzes Excel spreadsheets.".
