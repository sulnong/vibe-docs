---
title: "GitHub Address Comments Skill"
description: "GitHub Address Comments Skill: Addresses review and issue comments on open GitHub pull requests via CLI."
---

# GitHub Address Comments Skill

Addresses review and issue comments on open GitHub pull requests via CLI.

This page helps you decide whether to install or invoke `openai/gh-address-comments`, and how to keep the first use bounded.
...
| Directory listing | https://officialskills.sh/openai/skills/gh-address-comments |
| Primary source | https://officialskills.sh/openai/skills/gh-address-comments |
...
Start from the listing page: https://officialskills.sh/openai/skills/gh-address-comments

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/openai/skills/gh-address-comments
...
- Whether `openai/gh-address-comments` is better than a one-off prompt for this task.
...
- If the task is closer to "Guides the creation of skills that extend an agent with specialized workflows.", check [Skill Creator Skill](/en/awesome-skills/skill-creator/) first; use this page when the focus remains "Addresses review and issue comments on open GitHub pull requests via CLI.".
- If the task is closer to "Provides a basic template for creating new skills.", check [Template Skill](/en/awesome-skills/template/) first; use this page when the focus remains "Addresses review and issue comments on open GitHub pull requests via CLI.".
- If the task is closer to "Debugs and fixes failing GitHub Actions checks through log inspection.", check [GitHub Fix CI Skill](/en/awesome-skills/gh-fix-ci/) first; use this page when the focus remains "Addresses review and issue comments on open GitHub pull requests via CLI.".
- If the task is closer to "Creates clean, reproducible Jupyter notebooks for experiments and tutorials.", check [Jupyter Notebook Skill](/en/awesome-skills/jupyter-notebook/) first; use this page when the focus remains "Addresses review and issue comments on open GitHub pull requests via CLI.".
