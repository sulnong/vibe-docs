---
title: "DOCX Skill"
description: "DOCX Skill: Creates, edits, and analyzes Microsoft Word documents."
---

# DOCX Skill

Creates, edits, and analyzes Microsoft Word documents.

This page helps you decide whether to install or invoke `anthropics/docx`, and how to keep the first use bounded.
...
| Directory listing | https://officialskills.sh/anthropics/skills/docx |
| Primary source | https://officialskills.sh/anthropics/skills/docx |
...
Start from the listing page: https://officialskills.sh/anthropics/skills/docx

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/anthropics/skills/docx
...
- Whether `anthropics/docx` is better than a one-off prompt for this task.
...
- If the task is closer to "Extracts text, creates PDFs, and handles PDF forms and review tasks.", check [PDF Skill](/en/awesome-skills/pdf/) first; use this page when the focus remains "Creates, edits, and analyzes Microsoft Word documents.".
- If the task is closer to "Creates, edits, and analyzes PowerPoint presentations.", check [PPTX Skill](/en/awesome-skills/pptx/) first; use this page when the focus remains "Creates, edits, and analyzes Microsoft Word documents.".
- If the task is closer to "Creates, edits, and analyzes Excel spreadsheets.", check [XLSX Skill](/en/awesome-skills/xlsx/) first; use this page when the focus remains "Creates, edits, and analyzes Microsoft Word documents.".
- If the task is closer to "Provides authoritative guidance from OpenAI developer documentation.", check [OpenAI Docs Skill](/en/awesome-skills/openai-docs/) first; use this page when the focus remains "Creates, edits, and analyzes Microsoft Word documents.".
