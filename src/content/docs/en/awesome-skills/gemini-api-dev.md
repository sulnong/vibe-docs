...
description: "Gemini API Dev Skill: Provides best practices for developing Gemini-powered apps with the Gemini API."
---

# Gemini API Dev Skill

Provides best practices for developing Gemini-powered apps with the Gemini API.

This page helps you decide whether to install or invoke `google-gemini/gemini-api-dev`, and how to keep the first use bounded.

## Quick facts

| Field | Value |
| --- | --- |
| Skill | `google-gemini/gemini-api-dev` |
| Category | [AI, ML, and Model Platforms](/en/awesome-skills/categories/ai-ml-models/) |
| Directory listing | https://officialskills.sh/google-gemini/skills/gemini-api-dev |
| Primary source | https://officialskills.sh/google-gemini/skills/gemini-api-dev |
...
Start from the listing page: https://officialskills.sh/google-gemini/skills/gemini-api-dev

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/google-gemini/skills/gemini-api-dev
...
- Whether `google-gemini/gemini-api-dev` is better than a one-off prompt for this task.
...
- If the task is closer to "Guides Gemini-powered app development on Google Cloud Vertex AI.", check [Vertex AI API Dev Skill](/en/awesome-skills/vertex-ai-api-dev/) first; use this page when the focus remains "Provides best practices for developing Gemini-powered apps with the Gemini API.".
- If the task is closer to "Uses the Hugging Face CLI for Hub operations.", check [Hugging Face CLI Skill](/en/awesome-skills/hf-cli/) first; use this page when the focus remains "Provides best practices for developing Gemini-powered apps with the Gemini API.".
- If the task is closer to "Trains models with TRL workflows such as SFT, DPO, GRPO, and GGUF conversion.", check [Hugging Face Model Trainer Skill](/en/awesome-skills/hugging-face-model-trainer/) first; use this page when the focus remains "Provides best practices for developing Gemini-powered apps with the Gemini API.".
- If the task is closer to "Discovers, compares, and runs AI models through Replicate.", check [Replicate Skill](/en/awesome-skills/replicate/) first; use this page when the focus remains "Provides best practices for developing Gemini-powered apps with the Gemini API.".
...
- [Vertex AI API Dev Skill](/en/awesome-skills/vertex-ai-api-dev/) - Guides Gemini-powered app development on Google Cloud Vertex AI.
- [Hugging Face CLI Skill](/en/awesome-skills/hf-cli/) - Uses the Hugging Face CLI for Hub operations.
- [Hugging Face Model Trainer Skill](/en/awesome-skills/hugging-face-model-trainer/) - Trains models with TRL workflows such as SFT, DPO, GRPO, and GGUF conversion.
- [Replicate Skill](/en/awesome-skills/replicate/) - Discovers, compares, and runs AI models through Replicate.
