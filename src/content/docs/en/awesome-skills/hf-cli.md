...
description: "Hugging Face CLI Skill: Uses the Hugging Face CLI for Hub operations."
---

# Hugging Face CLI Skill

Uses the Hugging Face CLI for Hub operations.

This page helps you decide whether to install or invoke `huggingface/hf-cli`, and how to keep the first use bounded.
...
| Directory listing | https://officialskills.sh/huggingface/skills/hf-cli |
| Primary source | https://officialskills.sh/huggingface/skills/hf-cli |
...
Start from the listing page: https://officialskills.sh/huggingface/skills/hf-cli

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/huggingface/skills/hf-cli
...
- Whether `huggingface/hf-cli` is better than a one-off prompt for this task.
...
- If the task is closer to "Provides best practices for developing Gemini-powered apps with the Gemini API.", check [Gemini API Dev Skill](/en/awesome-skills/gemini-api-dev/) first; use this page when the focus remains "Uses the Hugging Face CLI for Hub operations.".
- If the task is closer to "Guides Gemini-powered app development on Google Cloud Vertex AI.", check [Vertex AI API Dev Skill](/en/awesome-skills/vertex-ai-api-dev/) first; use this page when the focus remains "Uses the Hugging Face CLI for Hub operations.".
- If the task is closer to "Trains models with TRL workflows such as SFT, DPO, GRPO, and GGUF conversion.", check [Hugging Face Model Trainer Skill](/en/awesome-skills/hugging-face-model-trainer/) first; use this page when the focus remains "Uses the Hugging Face CLI for Hub operations.".
- If the task is closer to "Discovers, compares, and runs AI models through Replicate.", check [Replicate Skill](/en/awesome-skills/replicate/) first; use this page when the focus remains "Uses the Hugging Face CLI for Hub operations.".
...
- [Gemini API Dev Skill](/en/awesome-skills/gemini-api-dev/) - Provides best practices for developing Gemini-powered apps with the Gemini API.
