---
title: "Playwright Interactive Skill"
description: "Playwright Interactive Skill: Provides persistent browser and Electron interaction through an interactive JavaScript REPL."
---

# Playwright Interactive Skill

Provides persistent browser and Electron interaction through an interactive JavaScript REPL.

This page helps you decide whether to install or invoke `openai/playwright-interactive`, and how to keep the first use bounded.

## Quick facts

| Field | Value |
| --- | --- |
| Skill | `openai/playwright-interactive` |
| Category | [Browser, Testing, Quality](/en/awesome-skills/categories/browser-testing-quality/) |
| Directory listing | https://officialskills.sh/openai/skills/playwright-interactive |
| Primary source | https://officialskills.sh/openai/skills/playwright-interactive |
...
Start from the listing page: https://officialskills.sh/openai/skills/playwright-interactive

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/openai/skills/playwright-interactive
...
- Whether `openai/playwright-interactive` is better than a one-off prompt for this task.
...
- If the task is closer to "Automates a real browser from the terminal with `playwright-cli` for navigation, forms, snapshots, screenshots, extraction, and UI-flow debugging.", check [Playwright Skill](/en/awesome-skills/playwright/) first; use this page when the focus remains "Provides persistent browser and Electron interaction through an interactive JavaScript REPL.".
- If the task is closer to "Tests local web applications using Playwright-oriented workflows.", check [Webapp Testing Skill](/en/awesome-skills/webapp-testing/) first; use this page when the focus remains "Provides persistent browser and Electron interaction through an interactive JavaScript REPL.".
- If the task is closer to "Runs broad web quality reviews across performance, accessibility, SEO, and best practices.", check [Web Quality Audit Skill](/en/awesome-skills/web-quality-audit/) first; use this page when the focus remains "Provides persistent browser and Electron interaction through an interactive JavaScript REPL.".
- If the task is closer to "Diagnoses and improves LCP, INP, and CLS issues.", check [Core Web Vitals Skill](/en/awesome-skills/core-web-vitals/) first; use this page when the focus remains "Provides persistent browser and Electron interaction through an interactive JavaScript REPL.".
...
- [Core Web Vitals Skill](/en/awesome-skills/core-web-vitals/) - Diagnoses and improves LCP, INP, and CLS issues.
