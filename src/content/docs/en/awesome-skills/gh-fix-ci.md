---
title: "GitHub Fix CI Skill"
description: "GitHub Fix CI Skill: Debugs and fixes failing GitHub Actions checks through log inspection."
---

# GitHub Fix CI Skill

Debugs and fixes failing GitHub Actions checks through log inspection.

This page helps you decide whether to install or invoke `openai/gh-fix-ci`, and how to keep the first use bounded.
...
| Directory listing | https://officialskills.sh/openai/skills/gh-fix-ci |
| Primary source | https://officialskills.sh/openai/skills/gh-fix-ci |
...
Start from the listing page: https://officialskills.sh/openai/skills/gh-fix-ci

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/openai/skills/gh-fix-ci
...
- Whether `openai/gh-fix-ci` is better than a one-off prompt for this task.
...
- If the task is closer to "Guides the creation of skills that extend an agent with specialized workflows.", check [Skill Creator Skill](/en/awesome-skills/skill-creator/) first; use this page when the focus remains "Debugs and fixes failing GitHub Actions checks through log inspection.".
- If the task is closer to "Provides a basic template for creating new skills.", check [Template Skill](/en/awesome-skills/template/) first; use this page when the focus remains "Debugs and fixes failing GitHub Actions checks through log inspection.".
- If the task is closer to "Addresses review and issue comments on open GitHub pull requests via CLI.", check [GitHub Address Comments Skill](/en/awesome-skills/gh-address-comments/) first; use this page when the focus remains "Debugs and fixes failing GitHub Actions checks through log inspection.".
- If the task is closer to "Creates clean, reproducible Jupyter notebooks for experiments and tutorials.", check [Jupyter Notebook Skill](/en/awesome-skills/jupyter-notebook/) first; use this page when the focus remains "Debugs and fixes failing GitHub Actions checks through log inspection.".
