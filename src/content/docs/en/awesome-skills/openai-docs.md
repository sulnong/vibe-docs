...
description: "OpenAI Docs Skill: Provides authoritative guidance from OpenAI developer documentation."
---

# OpenAI Docs Skill

Provides authoritative guidance from OpenAI developer documentation.

This page helps you decide whether to install or invoke `openai/openai-docs`, and how to keep the first use bounded.

## Quick facts

| Field | Value |
| --- | --- |
| Skill | `openai/openai-docs` |
| Category | [Documents and Knowledge Work](/en/awesome-skills/categories/documents-knowledge/) |
| Directory listing | https://officialskills.sh/openai/skills/openai-docs |
| Primary source | https://officialskills.sh/openai/skills/openai-docs |
...
Start from the listing page: https://officialskills.sh/openai/skills/openai-docs

If the page provides an install command, copy the command from the listing instead of reconstructing it from the URL. If your agent client supports GitHub skill paths, use the primary source: https://officialskills.sh/openai/skills/openai-docs
...
- Whether `openai/openai-docs` is better than a one-off prompt for this task.
...
- If the task is closer to "Creates, edits, and analyzes Microsoft Word documents.", check [DOCX Skill](/en/awesome-skills/docx/) first; use this page when the focus remains "Provides authoritative guidance from OpenAI developer documentation.".
- If the task is closer to "Extracts text, creates PDFs, and handles PDF forms and review tasks.", check [PDF Skill](/en/awesome-skills/pdf/) first; use this page when the focus remains "Provides authoritative guidance from OpenAI developer documentation.".
- If the task is closer to "Creates, edits, and analyzes PowerPoint presentations.", check [PPTX Skill](/en/awesome-skills/pptx/) first; use this page when the focus remains "Provides authoritative guidance from OpenAI developer documentation.".
- If the task is closer to "Creates, edits, and analyzes Excel spreadsheets.", check [XLSX Skill](/en/awesome-skills/xlsx/) first; use this page when the focus remains "Provides authoritative guidance from OpenAI developer documentation.".
