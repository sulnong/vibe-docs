...
description: "Replicate Skill: Discovers, compares, and runs AI models through Replicate."
---

# Replicate Skill

Discovers, compares, and runs AI models through Replicate.
...
Start from the listing page: https://officialskills.sh/replicate/skills/replicate
...
- Whether `replicate/replicate` is better than a one-off prompt for this task.
...
- If the task is closer to "Provides best practices for developing Gemini-powered apps with the Gemini API.", check [Gemini API Dev Skill](/en/awesome-skills/gemini-api-dev/) first; use this page when the focus remains "Discovers, compares, and runs AI models through Replicate.".
- If the task is closer to "Guides Gemini-powered app development on Google Cloud Vertex AI.", check [Vertex AI API Dev Skill](/en/awesome-skills/vertex-ai-api-dev/) first; use this page when the focus remains "Discovers, compares, and runs AI models through Replicate.".
- If the task is closer to "Uses the Hugging Face CLI for Hub operations.", check [Hugging Face CLI Skill](/en/awesome-skills/hf-cli/) first; use this page when the focus remains "Discovers, compares, and runs AI models through Replicate.".
- If the task is closer to "Trains models with TRL workflows such as SFT, DPO, GRPO, and GGUF conversion.", check [Hugging Face Model Trainer Skill](/en/awesome-skills/hugging-face-model-trainer/) first; use this page when the focus remains "Discovers, compares, and runs AI models through Replicate.".
