---
title: "Hermes Agent: Troubleshooting"
description: "Troubleshooting for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---
...
- Search intent: Diagnose common Hermes failures by symptom class.
- Core question: What should be checked first, which source should verify the behavior, and when should an upstream issue be filed?
- Differentiated angle: Sort by symptom and minimal diagnostic step instead of building an error-message encyclopedia.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Symptom Class" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Minimal Diagnostic Step" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Likely Boundary" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Source to Recheck" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
### 5. Issue Filing Evidence

Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Issue Filing Evidence" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about Troubleshooting. What should be checked first, which source should verify the behavior, and when should an upstream issue be filed?
