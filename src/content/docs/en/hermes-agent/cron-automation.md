---
title: "Hermes Agent: Cron Automation"
description: "Cron Automation for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---
...
- Search intent: Use Hermes scheduled tasks for recurring work.
- Core question: How should natural-language jobs, skill-backed jobs, script-only jobs, delivery targets, and recovery paths be designed?
- Differentiated angle: Distinguish LLM jobs, script jobs, and skill-backed jobs so failure handling is explicit.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about Cron Automation. How should natural-language jobs, skill-backed jobs, script-only jobs, delivery targets, and recovery paths be designed?
