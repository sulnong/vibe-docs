...
description: "Kanban Multi-Agent Board for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---

# Hermes Agent: Kanban Multi-Agent Board
...
- Search intent: Use Hermes Kanban for durable multi-agent coordination.
- Core question: How is Kanban different from `delegate_task`, and which long-running tasks deserve a board?
- Differentiated angle: Treat Kanban as a project-management and worker-coordination surface, not a simple todo list.
- Research baseline: 2026-05-22/23

## Editorial Notes

- Kanban is the durable coordination surface. `delegate_task` is for bounded side work; Kanban is for work that needs tasks, workers, heartbeats, retries, evidence, and human or dashboard visibility.
- The release history around v0.13.0 makes Kanban central to the “agent finishes what it starts” story.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about Kanban Multi-Agent Board. How is Kanban different from `delegate_task`, and which long-running tasks deserve a board?
