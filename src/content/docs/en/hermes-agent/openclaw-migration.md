---
title: "Hermes Agent: OpenClaw Migration"
description: "OpenClaw Migration for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---
...
- Search intent: Move OpenClaw data and habits into Hermes without overwriting long-lived state blindly.
- Core question: What should be dry-run, backed up, imported, verified, or rolled back during migration?
- Differentiated angle: Make backup and post-migration verification first-class, not optional cleanup.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about OpenClaw Migration. What should be dry-run, backed up, imported, verified, or rolled back during migration?
