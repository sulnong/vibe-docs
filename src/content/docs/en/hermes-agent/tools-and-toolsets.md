...
description: "Tools and Toolsets for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---
...
- Search intent: Understand which Hermes tools are available and how toolsets change risk.
- Core question: Which file, terminal, web, browser, media, memory, and orchestration tools should be exposed for a task?
- Differentiated angle: Group tools by permission and blast radius instead of listing every tool name first.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about Tools and Toolsets. Which file, terminal, web, browser, media, memory, and orchestration tools should be exposed for a task?
