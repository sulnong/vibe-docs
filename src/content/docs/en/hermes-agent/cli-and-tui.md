---
title: "Hermes Agent: CLI and TUI Workflow"
description: "CLI and TUI Workflow for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---

# Hermes Agent: CLI and TUI Workflow
...
- Search intent: Use Hermes CLI and TUI as the daily operating surface.
- Core question: How do startup modes, slash commands, keybindings, interrupts, retries, context compaction, and session management fit into a workday?
- Differentiated angle: Organize the page by real usage loops: open project, read context, execute task, interrupt, recover, and review.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about CLI and TUI Workflow. How do startup modes, slash commands, keybindings, interrupts, retries, context compaction, and session management fit into a workday?
