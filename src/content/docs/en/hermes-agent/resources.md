...
description: "Resources for Hermes Agent: source-linked guidance, task maps, tradeoffs, pitfalls, and update notes."
---
...
- Search intent: Find the canonical sources for Hermes Agent facts and updates.
- Core question: Where should installation facts, API behavior, security claims, version changes, and community symptoms be checked?
- Differentiated angle: Group links by the kind of fact they can verify.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Official Sources" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Version Sources" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Security Sources" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
### 4. Examples and Community

Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Examples and Community" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Use this section to reduce a broad documentation topic into a decision the reader can act on. For Hermes Agent, "Watch Checklist" should name the input, the expected output, the verification signal, and the source that proves the behavior.
...
Recheck the official documentation, package metadata, repository README, release or changelog notes, and any linked API reference before updating claims about Resources. Where should installation facts, API behavior, security claims, version changes, and community symptoms be checked?
