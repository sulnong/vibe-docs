---
title: "Hermes Agent：工具与工具集"
description: "Hermes Agent 的工具与工具集：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---
...
- 核心问题：Hermes 能调用哪些工具，如何按平台和风险控制？
- 差异化角度：按“读写本地文件、联网、浏览器、媒体、agent orchestration”给权限分级。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"tool category" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"toolsets" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"terminal/files" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"web/browser/media" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"agent orchestration" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"memory/session search" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 7. per-platform tool access

这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"per-platform tool access" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 能调用哪些工具，如何按平台和风险控制？ 对 Hermes Agent 来说，"后台进程" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
tools、tools reference、toolsets reference、browser、web-search。
