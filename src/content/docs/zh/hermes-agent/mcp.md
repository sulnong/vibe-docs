---
title: "Hermes Agent：MCP 与外部工具生态"
description: "Hermes Agent 的MCP 与外部工具生态：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：MCP 与外部工具生态
...
- 核心问题：如何接 MCP，如何过滤工具，如何控制风险？
- 差异化角度：用“只暴露必要工具”的配置策略组织，而不是堆 MCP 示例。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"stdio/HTTP" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"config keys" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"presets" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"tool registration" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 5. resources/prompts utility tools

这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"resources/prompts utility tools" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 6. per-server include/exclude

这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"per-server include/exclude" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"OAuth" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 8. server-initiated LLM requests

这一节用来回答本页背后的实际问题：如何接 MCP，如何过滤工具，如何控制风险？ 对 Hermes Agent 来说，"server-initiated LLM requests" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
MCP guide、MCP config reference、use MCP with Hermes、security。
