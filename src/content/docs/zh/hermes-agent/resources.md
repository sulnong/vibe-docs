---
title: "Hermes Agent：资源与更新追踪"
description: "Hermes Agent 的资源与更新追踪：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：资源与更新追踪
...
- 核心问题：哪些来源用于验证事实，如何追踪版本变化？
- 差异化角度：按“安装事实、功能事实、安全事实、版本事实、社区问题”分类链接。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"官方文档" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"GitHub" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"PyPI" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"release" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"skills catalogs" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"security policy" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"community" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：哪些来源用于验证事实，如何追踪版本变化？ 对 Hermes Agent 来说，"watch checklist" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
所有官方来源、release、PyPI、Discord、issues/discussions。
