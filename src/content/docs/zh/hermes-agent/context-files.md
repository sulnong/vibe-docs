---
title: "Hermes Agent：Context Files 与项目指令"
description: "Hermes Agent 的Context Files 与项目指令：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：Context Files 与项目指令
...
- 核心问题：项目指令、人格、inline references 如何影响每次对话？
- 差异化角度：把“长期偏好”和“项目规则”拆开，减少跨项目污染。
- 研究基线：2026-05-22/23
...
### 1. AGENTS.md/CLAUDE.md/.hermes.md/.cursorrules

这一节用来回答本页背后的实际问题：项目指令、人格、inline references 如何影响每次对话？ 对 Hermes Agent 来说，"AGENTS.md/CLAUDE.md/.hermes.md/.cursorrules" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：项目指令、人格、inline references 如何影响每次对话？ 对 Hermes Agent 来说，"SOUL.md" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：项目指令、人格、inline references 如何影响每次对话？ 对 Hermes Agent 来说，"context references `@`" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：项目指令、人格、inline references 如何影响每次对话？ 对 Hermes Agent 来说，"注入顺序" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：项目指令、人格、inline references 如何影响每次对话？ 对 Hermes Agent 来说，"安全扫描" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：项目指令、人格、inline references 如何影响每次对话？ 对 Hermes Agent 来说，"团队维护规则" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
context-files、context-references、personality、tips。
