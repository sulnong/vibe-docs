---
title: "Hermes Agent：记忆与会话搜索"
description: "Hermes Agent 的记忆与会话搜索：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：记忆与会话搜索
...
- 核心问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？
- 差异化角度：给出“应该保存/不应该保存”的任务地图和污染回滚策略。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"MEMORY.md" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"USER.md" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"session storage" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"session_search" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"capacity" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"duplicate prevention" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"security scanning" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 8. external memory providers

这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"external memory providers" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：Hermes 怎样记住用户、项目和过去对话，什么不该存？ 对 Hermes Agent 来说，"排错" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
memory、sessions、memory-providers、session-storage、Honcho。
