---
title: "Hermes Agent：OpenClaw 迁移"
description: "Hermes Agent 的OpenClaw 迁移：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：OpenClaw 迁移
...
- 核心问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？
- 差异化角度：给“迁移前备份/迁移后验证”清单，避免一次性覆盖用户长期记忆。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"自动检测" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"interactive migration" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"dry run" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"presets" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"overwrite" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"导入内容" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"workspace instructions" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：迁移哪些数据，哪些要 dry-run，哪些冲突要人工处理？ 对 Hermes Agent 来说，"回滚与审计" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
README、migrate-from-openclaw guide、CLI reference。
