---
title: "Hermes Agent：Gateway 与消息平台"
description: "Hermes Agent 的Gateway 与消息平台：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：Gateway 与消息平台
...
- 核心问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？
- 差异化角度：写“先 CLI 稳定再 gateway”的部署路径，以及 allowlist/DM pairing 运维习惯。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"platform matrix" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"gateway architecture" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"setup sequence" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"session continuity" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 5. files/images/voice

这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"files/images/voice" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 6. busy-input/interrupt

这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"busy-input/interrupt" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"background sessions" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何让 Hermes 从 CLI 变成跨平台长期 assistant？ 对 Hermes Agent 来说，"gateway status" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
messaging overview、Telegram、Discord、Slack、WhatsApp、Signal、Email、Teams、gateway internals。
