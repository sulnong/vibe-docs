---
title: "Hermes Agent：排错路径"
description: "Hermes Agent 的排错路径：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---
...
- 核心问题：出现问题时先查什么，什么时候回到 docs/issues？
- 差异化角度：按症状排序，每个症状给最小诊断命令和下一步，而不是错误消息大全。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"install command not found" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 2. API key/provider wrong

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"API key/provider wrong" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 3. custom endpoint returns bad output

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"custom endpoint returns bad output" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 4. gateway nobody can message

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"gateway nobody can message" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 5. doctor flags config

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"doctor flags config" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 6. skills install failure

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"skills install failure" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"Windows/Termux" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 8. delegate/gateway issues

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"delegate/gateway issues" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 9. issue filing template

这一节用来回答本页背后的实际问题：出现问题时先查什么，什么时候回到 docs/issues？ 对 Hermes Agent 来说，"issue filing template" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
quickstart common failure modes、installation troubleshooting、FAQ、issues、security reporting。
