---
title: "Hermes Agent：架构与源码阅读路径"
description: "Hermes Agent 的架构与源码阅读路径：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：架构与源码阅读路径
...
- 核心问题：想改 Hermes 或排查 bug 应该从哪些模块读起？
- 差异化角度：给“按任务读源码”的路径：加 provider、加 tool、修 gateway、查 memory、查 security。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"system overview" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"directory map" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 3. CLI/gateway/cron data flow

这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"CLI/gateway/cron data flow" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"agent loop" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"prompt builder" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"provider runtime" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"tool runtime" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"session storage" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"gateway internals" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：想改 Hermes 或排查 bug 应该从哪些模块读起？ 对 Hermes Agent 来说，"plugin system" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
architecture、agent-loop、prompt-assembly、provider-runtime、tools-runtime、gateway-internals、session-storage、repo tree。
