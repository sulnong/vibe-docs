---
title: "Hermes Agent：Subagent Delegation 与并行"
description: "Hermes Agent 的Subagent Delegation 与并行：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：Subagent Delegation 与并行
...
- 核心问题：什么时候用 delegation，什么时候不要并行？
- 差异化角度：给真实模式：parallel research、code review + fix、多文件重构；提醒不要把阻塞关键路径丢给子 agent。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"single task" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"parallel batch" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"context inheritance" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"toolset selection" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"max iterations" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"child timeout" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"monitoring" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"depth limit" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候用 delegation，什么时候不要并行？ 对 Hermes Agent 来说，"examples" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
delegation feature、delegation patterns、agent loop、tools。
