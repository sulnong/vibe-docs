---
title: "Hermes Agent：Skills 系统"
description: "Hermes Agent 的Skills 系统：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---
...
- 核心问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？
- 差异化角度：明确 skill 与 memory/context/plugin/MCP 的边界，避免读者把所有扩展都塞进 skill。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"progressive disclosure" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"SKILL.md" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 3. bundled/optional/user skills

这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"bundled/optional/user skills" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"secure setup" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"skill output" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"curator" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"自建 skill" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：skills 是提示词、插件、记忆还是工作流？什么时候会自动创建/改进？ 对 Hermes Agent 来说，"常见坑" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
skills、skills catalog、optional skills catalog、curator、creating skills。
