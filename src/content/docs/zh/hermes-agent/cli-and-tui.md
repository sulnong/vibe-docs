---
title: "Hermes Agent：CLI 与 TUI 日常工作流"
description: "Hermes Agent 的CLI 与 TUI 日常工作流：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Hermes Agent：CLI 与 TUI 日常工作流
...
- 核心问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？
- 差异化角度：按“真实工作日”组织：打开项目、读 context、执行任务、中断纠偏、压缩/恢复、回顾。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"启动模式" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"status bar" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"keybindings" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"slash commands" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"multi-line input" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"interrupt" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"background sessions" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：CLI/TUI 如何启动、切模型、重试、撤销、中断、压缩上下文、管理 session？ 对 Hermes Agent 来说，"preload skills" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
CLI、TUI、slash commands reference、sessions。
