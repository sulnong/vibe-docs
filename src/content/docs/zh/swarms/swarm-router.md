---
title: "Swarms：SwarmRouter"
description: "Swarms 的SwarmRouter：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---
...
- 核心问题：如何用统一接口切换 architecture？
- 差异化角度：写成“实验架构选择器”，适合早期探索，不要把所有复杂度藏在 auto。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"SwarmType" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"constructor" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"required params" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"auto mode" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"autosave" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"collab prompt" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"reliability_check" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 8. run/batch/concurrent

这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"run/batch/concurrent" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：如何用统一接口切换 architecture？ 对 Swarms 来说，"配置错误" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
api/swarm-router、architectures/swarm-router、examples/swarm-router。
