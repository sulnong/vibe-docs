---
title: "Swarms：Reasoning Agents"
description: "Swarms 的Reasoning Agents：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---

# Swarms：Reasoning Agents
...
- 核心问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？
- 差异化角度：把它们定位为“提高推理/评价/一致性”的策略，不是默认替代。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"Self-Consistency" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"Reflexion" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"GKP" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"IRE" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"Reasoning Duo" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"Agent Judge" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"router" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"适用任务" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：这些 paper-inspired agents 什么时候比普通 Agent 更合适？ 对 Swarms 来说，"成本" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
reasoning agents overview、各 agent page、agent judge、references。
