---
title: "Swarms：SequentialWorkflow"
description: "Swarms 的SequentialWorkflow：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---
...
- 核心问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？
- 差异化角度：写清“上一个 agent 的输出就是下一个 agent 的输入”的数据契约。
- 研究基线：2026-05-22/23
...
这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"概念" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"关键参数" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 3. run/run_batched/run_async/run_stream

这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"run/run_batched/run_async/run_stream" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"team awareness" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"autosave" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"drift_detection" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
### 7. blog/research pipeline 示例

这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"blog/research pipeline 示例" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：什么时候线性 pipeline 最合适，如何处理 drift 和输出？ 对 Swarms 来说，"坑点" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
api/sequential-workflow、architectures/sequential-workflow、quickstart、examples/sequential-workflow。
