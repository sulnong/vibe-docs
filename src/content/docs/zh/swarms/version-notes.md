---
title: "Swarms：版本变化与迁移"
description: "Swarms 的版本变化与迁移：包含来源链接、任务地图、取舍、坑点和更新基线的中文指南。"
---
...
- 核心问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？
- 差异化角度：指出 release 来源不同步风险，正式使用前以 PyPI + docs changelog + installed package 为准。
- 研究基线：2026-05-22/23
...
### 1. PyPI vs GitHub release 差异

这一节用来回答本页背后的实际问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？ 对 Swarms 来说，"PyPI vs GitHub release 差异" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？ 对 Swarms 来说，"v12 features" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？ 对 Swarms 来说，"bug fixes" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？ 对 Swarms 来说，"behavior changes" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？ 对 Swarms 来说，"migration checklist" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
这一节用来回答本页背后的实际问题：v12 引入了哪些会改变行为的能力，版本事实从哪里核验？ 对 Swarms 来说，"watch points" 不应该停留在概念解释，而要写清输入、期望输出、验证信号和能证明该行为的来源。
...
PyPI、changelog v12、GitHub releases、commits。
