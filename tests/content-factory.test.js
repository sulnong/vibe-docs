...
test('buildTopicDossier creates a reviewable internal dossier for open-source topics', () => {
...
test('classifySources separates official facts, competitor intent, and community pain', () => {
...
test('summarizeDossierReadiness reports missing evidence before publication', () => {
  const dossier = buildTopicDossier({
    topic: {
      slug: 'thin',
      title: 'Thin',
